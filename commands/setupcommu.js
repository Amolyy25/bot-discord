...
const CHANNELS_CONFIG = [
    {
        name: '│👘・vote2profil',
        key: 'vote2profil',
        embedTitle: '👘 VOTE2PROFIL — Soumets ton profil !',
        embedDesc: [
            '**Comment ça marche ?**',
            '> Clique sur le bouton ci-dessous pour soumettre **ton propre profil** à la communauté.',
            '> Ajoute une photo et une courte présentation, et laisse la commu voter pour toi !',
            '',
            '📌 **Règles :**',
            '• 1 soumission par personne et par jour.',
            '• Ta soumission est validée par le staff avant publication.',
            '• La commu vote avec 👍 / 👎 une fois ton profil publié.',
        ].join('\n'),
        embedColor: 0xE91E8C,
        buttonLabel: '👘 Soumettre mon profil',
    ...
    },
    {
        name: '│🗂️・les-dossiers',
        key: 'les_dossiers',
        embedTitle: '🗂️ LES DOSSIERS — Partage une info',
        embedDesc: [
            '**Comment ça marche ?**',
            '> Clique sur le bouton ci-dessous pour partager une information avec la commu.',
            '> Tu peux joindre une image. Ta soumission reste totalement anonyme.',
            '',
            '📌 **Règles :**',
            '• Ton identité n\'est jamais révélée publiquement.',
            '• Chaque dossier est validé par le staff avant publication.',
